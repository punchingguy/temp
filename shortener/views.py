import json
import urllib
from django.core.mail import EmailMessage# from django.conf import settings #for importing SHORTCODE_MAX,MIN values from settings
